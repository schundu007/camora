...
TOPIC_QUERIES: dict[str, list[str]] = {
    ...
    "fundamentals":                   ["system design fundamentals scalability availability reliability", "core system design concepts interview"],
    "databases":                      ["sql nosql database system design", "database selection system design interview"],
    "caching":                        ["caching strategies system design interview", "redis memcached caching distributed systems"],
    "message-queues":                 ["message queue system design kafka rabbitmq", "async messaging distributed systems"],
    "api-design":                     ["api design system design interview rest graphql grpc", "api gateway design patterns"],
    "load-balancing":                 ["load balancing system design interview algorithms", "load balancer layer 4 layer 7 design"],
    "rate-limiting":                  ["rate limiting system design interview algorithms", "token bucket sliding window rate limiter"],
    "microservices":                  ["microservices architecture system design interview", "service mesh microservices patterns"],
    "security":                       ["security system design interview authentication authorization", "distributed system security encryption"],
    "monitoring":                     ["observability monitoring system design metrics logs traces", "distributed system monitoring alerting"],
    "rest-vs-rpc":                    ["rest vs rpc grpc system design comparison", "api protocol comparison system design interview"],
    "quorum":                         ["quorum distributed systems system design", "quorum consensus consistency distributed databases"],
    "leader-follower":                ["leader follower replication distributed systems", "master replica database replication system design"],
    "heartbeat-mechanism":            ["heartbeat mechanism distributed systems failure detection", "health check distributed system design"],
    "checksum":                       ["checksum data integrity distributed systems", "error detection checksums distributed storage"],
    "strong-vs-eventual-consistency": ["strong eventual consistency distributed systems", "consistency models distributed systems cap theorem"],
    "latency-vs-throughput":          ["latency vs throughput system design tradeoffs", "performance optimization latency throughput distributed systems"],
    "acid-vs-base":                   ["acid vs base database properties system design", "transaction properties nosql sql comparison"],
    "distributed-messaging":          ["distributed messaging system design kafka pub sub", "event streaming message broker system design"],
    "synchronous-vs-asynchronous":    ["synchronous asynchronous communication system design", "async patterns distributed systems design"],
    "distributed-file-systems":       ["distributed file system design hdfs gfs", "distributed storage file system architecture"],
    "consistent-hashing":             ["consistent hashing system design interview", "distributed caching consistent hashing ring"],
    "bloom-filters":                  ["bloom filter system design interview", "probabilistic data structures bloom filter use cases"],
    "data-partitioning":              ["data partitioning sharding system design", "horizontal partitioning database sharding strategies"],
    "database-indexes":               ["database indexing system design interview", "btree hash index database performance optimization"],
    "proxies":                        ["proxy reverse proxy system design", "forward proxy reverse proxy load balancer api gateway"],
    "dns-deep-dive":                  ["dns system design how dns works", "domain name system dns resolution deep dive"],
    "cdn-deep-dive":                  ["cdn content delivery network system design", "cdn architecture push pull cache invalidation"],
    "redundancy-replication":         ["redundancy replication system design fault tolerance", "data replication strategies distributed systems"],
    "network-essentials":             ["networking fundamentals system design tcp udp http", "osi model network protocols system design"],
    "long-polling-websockets-sse":    ["websockets long polling server sent events comparison", "realtime communication protocols system design"],
    "cap-pacelc-deep-dive":           ["cap theorem pacelc distributed systems deep dive", "cap theorem consistency availability partition tolerance"],
    "distributed-lock":               ["distributed lock system design redis zookeeper", "distributed locking mechanisms concurrency control"],
    "cassandra-deep-dive":            ["apache cassandra system design deep dive", "cassandra architecture wide column store nosql"],
    "dynamodb-deep-dive":             ["aws dynamodb system design deep dive", "dynamodb architecture partition key design patterns"],
    "apache-flink-deep-dive":         ["apache flink stream processing system design", "flink architecture stateful stream processing"],
    "zookeeper-deep-dive":            ["apache zookeeper system design distributed coordination", "zookeeper architecture leader election distributed systems"],
    "vector-databases-deep-dive":     ["vector database system design embedding search", "vector database architecture similarity search faiss pinecone"],
}
