/* AUTO-GENERATED by apps/camora/scripts/extract-layered-design.mjs.
   ...
   an inline layeredDesign. The shape is consumed by TopicDiagram (which
   renders the pre-baked Graphviz PNG) and as alt-text/structured-data
   for the layered architecture sections. */

// Layer type defined locally so this file no longer depends on the deleted
// RoughLayeredDiagram.types module — strict TS builds were failing on the
// dangling import.
type Layer = {
  name: string;
  purpose: string;
