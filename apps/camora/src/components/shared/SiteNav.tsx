          ...
          <div className="hidden md:flex items-center gap-2 ml-auto">
            {isAuthenticated && (
              <button
                ...
                data-tip="Ask Cara (⌘K)"
              >
                <Chip variant="gold" className={`gap-1.5 cursor-pointer${theme === 'light' ? ' !bg-white !text-[var(--cam-primary)] !border-[var(--cam-primary)]/40' : ''}`}>
                  <span>✦</span>
                  <span>Cara</span>
                </Chip>
              </button>
            ...
            {isAuthenticated && (
              <Link to="/playground" className="no-underline" aria-label="Playground">
                <Chip variant="gold" className={`gap-1.5${theme === 'light' ? ' !bg-white !text-[var(--cam-primary)] !border-[var(--cam-primary)]/40' : ''}`}>
