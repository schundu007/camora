  ...
  return (
    <div className="w-4 h-4 rounded-full flex items-center justify-center shrink-0"
      style={{
        ...
        border: done ? `1px solid ${accent}` : '1px solid var(--border)',
...
export default function JobUrlAnalysisDemo() {
  ...
  return (
    <div className="relative rounded-2xl overflow-hidden"
      ...
      <div className="flex items-center justify-between px-5 py-3" style={{ background: 'var(--bg-elevated)', borderBottom: '1px solid var(--border)' }}>
          ...
          {PHASES.map((p, i) => (
            <div key={p} className="h-1 rounded-full transition-all duration-500"
              style={{
                ...
                background: i <= phaseIdx ? accent : 'var(--border)',
        ...
        {showHeader && (
          <motion.div key="header"
            ...
            <div className="text-[12px] flex items-center gap-1.5 mb-1.5" style={{ color: 'var(--text-muted)', fontFamily: F.mono }}>
              ...
              <span>/</span>
              <span style={{ color: 'var(--text-primary)', fontWeight: 600 }}>Prepare</span>
            </div>
            <p className="text-base font-bold leading-tight" style={{ fontFamily: F.display, color: 'var(--text-primary)' }}>
      ...
      <div className={`px-6 ${showHeader ? 'pt-2' : 'pt-6'} pb-5`}>
        <div className="flex items-center gap-3 px-4 py-3 rounded-xl"
          ...
          <svg width="14" height="14" fill="none" stroke="currentColor" style={{ color: 'var(--text-muted)' }} viewBox="0 0 24 24" strokeWidth={1.75}>
          ...
          <span className="text-sm truncate flex-1 min-w-0" style={{ color: 'var(--text-secondary)', fontFamily: F.mono }}>
      ...
      <div className="px-6 pb-6 min-h-[280px]">
          ...
          {phase === 'techstack' && (
            <motion.div key="tech" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
              ...
              <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 1.2 }}
                ...
                Matching to 1,500+ study topics…
              </motion.div>
            </motion.div>
          )}
        ...
        {showTech && phase !== 'techstack' && (
          <motion.div initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: 'auto' }}
            className="mt-5 pt-4 flex flex-wrap gap-1.5" style={{ borderTop: '1px dashed var(--border)' }}>
