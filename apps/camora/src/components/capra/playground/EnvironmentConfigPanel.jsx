    ...
    <div style={{ display: 'flex', flexDirection: 'column', flex: 1, overflow: 'hidden' }}>
      ...
      <div style={{ margin: '0 16px 14px', flexShrink: 0 }}>
        <div style={{
          ...
          <div style={{ color: 'rgba(255,255,255,0.25)', marginTop: 4, fontSize: 9 }}>
      ...
      <div style={{ marginTop: 'auto', padding: '10px 16px', borderTop: '1px solid var(--border)', flexShrink: 0 }}>
        <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
          <div style={{ display: 'flex', justifyContent: 'space-between' }}>
            <span style={{ fontSize: 9, color: 'var(--text-secondary)' }}>Duration</span>
            <span style={{ fontSize: 9, fontWeight: 700, color: 'var(--text-primary)', fontFamily: '"IBM Plex Mono", monospace' }}>60 min</span>
          </div>
          {specs.totalMem && (
            <div style={{ display: 'flex', justifyContent: 'space-between' }}>
              <span style={{ fontSize: 9, color: 'var(--text-secondary)' }}>Memory</span>
              <span style={{ fontSize: 9, fontWeight: 700, color: 'var(--text-primary)', fontFamily: '"IBM Plex Mono", monospace' }}>{specs.totalMem}</span>
            </div>
          )}
          {specs.bootTime && (
            <div style={{ display: 'flex', justifyContent: 'space-between' }}>
              <span style={{ fontSize: 9, color: 'var(--text-secondary)' }}>Boot time</span>
              <span style={{ fontSize: 9, fontWeight: 700, color: 'var(--text-primary)', fontFamily: '"IBM Plex Mono", monospace' }}>{specs.bootTime}</span>
            </div>
          )}
        </div>
      </div>
