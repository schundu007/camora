...
export const MicrophoneSelector = ({ disabled, onDeviceChange }: MicrophoneSelectorProps) => {
  ...
  return (
    <select
      ...
      className="appearance-none bg-[var(--bg-elevated)] border border-[var(--border)] text-[var(--text-primary)] font-bold text-sm px-1.5 py-1 min-h-[36px] w-[100px] sm:w-[120px] truncate focus:outline-none focus:ring-1 focus:ring-[var(--accent)] disabled:opacity-50 cursor-pointer rounded"
      style={{
