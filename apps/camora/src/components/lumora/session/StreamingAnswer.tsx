      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
        ...
        <div className="rounded-md border border-[var(--accent)]/15 overflow-hidden">
          <div className="flex items-center gap-2 px-3 py-2" style={{ background: 'var(--cam-hero-strip)', borderBottom: '1px solid var(--cam-gold-leaf)' }}>
            ...
            <span className="font-display text-[12px] font-bold tracking-[0.12em] uppercase text-[var(--cam-strip-heading)]">KEY POINTS</span>
          </div>
        ...
        <div className="rounded-md border border-[var(--warning)]/15 overflow-hidden">
          <div className="flex items-center gap-2 px-3 py-2" style={{ background: 'var(--cam-hero-strip)', borderBottom: '1px solid var(--cam-gold-leaf)' }}>
            ...
            <span className="font-display text-[12px] font-bold tracking-[0.12em] uppercase text-[var(--cam-strip-heading)]">FOLLOW-UP Q&amp;A</span>
          </div>
        ...
        <div className="flex items-center justify-between px-3 py-2 border-b border-gray-300 bg-[var(--bg-elevated)]">
          <div className="flex items-center gap-2">
            <div className="flex gap-1">
              <div className="w-2 h-2 rounded-full bg-[var(--danger)]/40" />
              <div className="w-2 h-2 rounded-full bg-[var(--warning)]/40" />
  ...
  return (
    <div className="rounded-lg border border-border bg-bg2 overflow-hidden">
      ...
      >
        ...
        <span className="font-display text-[12px] font-bold tracking-[0.12em] uppercase text-[var(--cam-strip-heading)]">
          {title}
        </span>
      </div>
      <div className="p-4">
          ...
          <div className="border border-[var(--accent)]/15 bg-[var(--accent)]/[0.02] overflow-hidden min-w-0 flex flex-col h-full">
            ...
            <div className="p-4 overflow-y-auto overflow-x-auto flex-1 flex flex-col items-center justify-center">
              <div className="text-center py-6">
                ...
                <p className="text-xs text-[var(--text-muted)] font-mono">Diagram generates after answer completes</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-3 flex flex-col gap-2">
          ...
          <div className="border border-[var(--warning)]/15 bg-[var(--warning)]/[0.02] overflow-hidden min-w-0">
            <div className="flex items-center gap-2 px-4 py-2 shrink-0" style={{ background: 'var(--cam-hero-strip)', borderBottom: '1px solid var(--cam-gold-leaf)' }}>
              <span className="inline-block w-1.5 h-1.5 rounded-full" style={{ background: 'var(--warning-text, var(--cam-gold-leaf-lt))' }} />
              <span className="font-mono text-[12px] font-bold tracking-widest uppercase text-[var(--cam-strip-heading)]">FOLLOW-UP Q&amp;A</span>
            </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
        {metrics.map((m, i) => (
          <div key={i} className="rounded-lg p-3" style={{ border: '1px solid var(--border)', background: 'var(--accent-subtle)' }}>
            <div className="font-mono text-[12px] font-bold text-text-dim uppercase tracking-wider mb-1.5">
              {m.label}
            </div>
