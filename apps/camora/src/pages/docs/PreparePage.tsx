...
export default function PrepareDocsPage() {
  return (
    <DocsPageLayout
      title="Prepare"
      description="Browse 1,500+ prep topics across 9 categories, generate company-specific prep, and use the SQL Playground and Resume Optimizer."
      path="/docs/prepare"
    ...
    >
      <section id="topic-library" className="mb-10 scroll-mt-24">
        ...
        <p className="text-[15px] leading-relaxed mb-3" style={{ color: 'var(--text-secondary)' }}>
          Camora ships with 1,500+ curated interview topics across 9 category families &mdash; coding,
