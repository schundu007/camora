    ...
    >
      ...
      <section id="admin-access" className="mb-10 scroll-mt-24">
        ...
        <ul className="list-disc pl-6 space-y-2 text-[15px]" style={{ color: 'var(--text-secondary)' }}>
          ...
          <li><Link to="/admin" className="text-[var(--accent)] underline">/admin</Link> — user list, plans, grant trial / toggle admin.</li>
          <li><Link to="/analytics" className="text-[var(--accent)] underline">/analytics</Link> — page views, visitors & usage stats.</li>
