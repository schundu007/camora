...
const APPA: Step[] = [
  ...
  },
  {
    ...
    headline: '9,000+ problems with AI feedback',
    desc: 'Coding, DSA, MCQ, system design, SQL — 9,000+ unique problems across 50+ domains with AI scoring.',
    Anim: PracticeAnim,
        ...
        <Container className="relative pt-16 pb-20 md:pt-24 md:pb-28">
          <div className="grid grid-cols-1 lg:grid-cols-[3fr_2fr] items-center gap-12 lg:gap-16">
            ...
            <div>
              ...
              >
                1,000+ matched roles, 1,400+ study topics, 9,000+ practice problems, and a live AI copilot AI assistance in real time: everything from first application to final offer.
              </motion.p>
        ...
        <Container>
          ...
          <div className="mt-14 grid grid-cols-1 lg:grid-cols-[3fr_2fr] gap-6">
            <AudienceCard
              ...
              body="1,000+ engineering roles matched to your skills, 1,400+ curated study topics with diagrams, and 9,000+ problems with AI feedback. Then live transcription assistance during the session itself: the moment that decides the offer."
