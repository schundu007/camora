  ...
  return (
    <div className="min-h-screen bg-[var(--bg-app)] flex flex-col">
      ...
      <section className="relative overflow-hidden" style={{ background: 'var(--cam-hero-bg)' }}>
        ...
        <div className="relative page-wrap pt-24 pb-20">
      ...
      <main className="flex-1 page-wrap pt-10 pb-16">
        ...
        <div className="border-t border-[var(--border)] pt-10 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center mt-6">
            <Link
              to="/signup"
              className="inline-flex items-center justify-center gap-2 px-6 py-2.5 bg-[var(--accent)] hover:opacity-90 text-white text-sm font-medium rounded-lg transition-colors"
            >
              Get Started Free
            </Link>
            <Link
