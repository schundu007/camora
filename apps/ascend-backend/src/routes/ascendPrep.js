...
router.post('/stream', async (req, res) => {
  ...
  let { jobDescription, resume, coverLetter, prepMaterials, documentation, sections, provider = 'groq', model, cloudProvider = 'aws' } = req.body;
...
router.post('/section', async (req, res) => {
  ...
  let { jobDescription, resume, coverLetter, prepMaterials, documentation, section, customDocumentContent, customDocumentName, companyName, provider = 'groq', model, cloudProvider = 'aws' } = req.body;
