...
// Path to the Python diagrams + Graphviz engine.
...
/**
 * Generate a cloud architecture diagram via the Python diagrams library
 * (Graphviz-rendered PNGs with cloud-vendor icon sets).
 *
