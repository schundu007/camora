    ...
    <div className="min-h-screen relative overflow-hidden" style={{ background: '#f8f9fb' }}>
      ...
      <div className="relative z-10 flex items-center justify-center min-h-[calc(100vh-80px)] px-4 py-8">
        <div className="w-full max-w-md bg-white rounded-2xl shadow-2xl shadow-black/8 border border-gray-200/60 p-8 md:p-10">
          ...
          {/* Divider */}
          <div className="mt-7 mb-6 border-t border-gray-100" />

          {/* Role selection */}
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1.5">Select your target role</label>
            <select value={role} onChange={(e) => setRole(e.target.value)}
                    className="w-full px-4 py-2.5 border border-gray-200 rounded-xl text-sm text-gray-700 bg-white focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all appearance-none"
