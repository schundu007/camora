...
export default function ScoreCard({
  ...
  if (compact) {
    return (
      <div className="flex items-center gap-3 bg-white border border-[#e3e8ee] rounded-xl px-4 py-3 hover:shadow-sm transition-shadow">
        {/* Mini score ring */}
  ...
  return (
    <div className="bg-white rounded-2xl border border-[#e3e8ee] shadow-[0_1px_3px_rgba(0,0,0,0.04)] overflow-hidden w-full max-w-md">
