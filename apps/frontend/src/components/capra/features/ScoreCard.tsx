...
export default function ScoreCard({
  ...
  if (compact) {
    return (
      <div className="flex items-center gap-3 bg-[var(--bg-surface)] border-0 rounded-xl px-4 py-3 shadow-[0_4px_24px_rgba(118,185,0,0.12)] hover:shadow-[0_20px_60px_rgba(118,185,0,0.28)] transition-shadow">
        {/* Mini score ring */}
  ...
  return (
    <div className="bg-[var(--bg-surface)] rounded-2xl border-0 shadow-[0_4px_24px_rgba(118,185,0,0.12)] overflow-hidden w-full max-w-md">
