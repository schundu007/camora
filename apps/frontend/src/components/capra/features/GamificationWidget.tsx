    ...
    <div style={{ background: 'linear-gradient(135deg, #0f172a 0%, #1e293b 50%, #0f172a 100%)', borderRadius: 16, padding: '18px 22px', position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ position: 'relative', display: 'flex', alignItems: 'center', gap: 20, flexWrap: 'wrap' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
          <div style={{ width: 52, height: 52, borderRadius: 14, background: 'linear-gradient(135deg, #10b981, #F97316)', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 4px 12px rgba(16,185,129,0.3)' }}>
          ...
          <div>
            ...
            <div style={{ width: 120, height: 5, borderRadius: 99, background: 'rgba(255,255,255,0.08)', overflow: 'hidden' }}>
              <div style={{ height: '100%', borderRadius: 99, background: 'linear-gradient(90deg, #10b981, #FB923C)', width: `${profile.progressPct}%`, transition: 'width 0.6s ease' }} />
            </div>
        ...
        <div style={{ display: 'flex', gap: 20 }}>
          {[
            ...
            { value: profile.problems_solved, label: 'Solved', color: '#FB923C', svgPath: 'M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4', stroke: true },
            { value: profile.xp.toLocaleString(), label: 'Total XP', color: '#FB923C', svgPath: 'M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.286 3.957a1 1 0 00.95.69h4.162c.969 0 1.371 1.24.588 1.81l-3.37 2.448a1 1 0 00-.364 1.118l1.287 3.957c.3.921-.755 1.688-1.54 1.118l-3.37-2.448a1 1 0 00-1.176 0l-3.37 2.448c-.784.57-1.838-.197-1.539-1.118l1.287-3.957a1 1 0 00-.364-1.118L2.063 9.384c-.783-.57-.38-1.81.588-1.81h4.162a1 1 0 00.95-.69l1.286-3.957z' },
          ].map(s => (
