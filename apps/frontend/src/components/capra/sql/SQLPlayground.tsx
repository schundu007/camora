            ...
            return (
              <div className="flex-1 flex items-center justify-center p-6">
                <div className="text-center max-w-sm">
                  {/* Celebration icon */}
                  <div className="w-16 h-16 mx-auto mb-4 rounded-2xl flex items-center justify-center" style={{ background: 'rgba(59,54,220,0.1)' }}>
                  ...
                  <div className="flex gap-3">
                    {nextUnsolved ? (
                      ...
                      <div className="flex-1 py-2.5 text-sm font-bold rounded-xl text-center" style={{ background: 'rgba(59,54,220,0.08)', color: 'var(--accent)' }}>
                        All problems solved!
                      </div>
                    )}
                    <button
