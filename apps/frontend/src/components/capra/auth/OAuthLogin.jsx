      ...
      <section className="px-6 md:px-12 py-10">
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-5 pt-6 px-2">
            {[
              { label: 'Apply', href: '/jobs', icon: 'briefcase', desc: 'Find your role', bg: '#ecfdf5', bgEnd: '#d1fae5', border: '#6ee7b7', borderEnd: '#34d399', badge: '#76B900', iconColor: '#76B900', glowColor: '16,185,129', slideFrom: 'left' },
