      ...
      content: (
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-3 gap-3">
            <div
              className="text-center p-4 rounded-lg transition-all hover:scale-105 bg-[var(--accent-subtle)] border border-[var(--border)]"
            >
              <div className="w-12 h-12 rounded-lg mx-auto mb-3 flex items-center justify-center bg-[var(--accent-subtle)]">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            {[
              ...
              >
                <div className="w-6 h-6 rounded-full flex items-center justify-center bg-[var(--accent-subtle)]">
      ...
      content: (
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-3 gap-3">
            ...
            <div
              className="p-4 rounded-lg text-center bg-[var(--accent-subtle)] border border-[var(--border)]"
            >
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          boxShadow: '0 25px 50px -12px rgba(0, 0, 0, 0.25), 0 0 30px var(--accent-subtle)',
        }}
      >
        {/* Progress bar */}
