  ...
  return (
    <div className="rounded-lg overflow-hidden border border-[var(--border)] bg-[var(--bg-surface)]">
      <div className="px-3 py-2 border-b border-[var(--border)] flex items-center gap-2 bg-[var(--bg-elevated)]">
        <Icon name="hash" size={16} className="text-[var(--text-secondary)]" />
        <h3 className="text-sm font-bold text-[var(--text-primary)] landing-display">{estimation.title || 'Capacity Planning'}</h3>
      </div>
...
function DataModelSection({ schema }) {
  ...
  if (tables.length > 0) {
    return (
      <div id="data-model" className="rounded-2xl overflow-hidden scroll-mt-24 border border-[var(--border)] bg-[var(--bg-surface)]">
        <div className="bg-[var(--bg-elevated)]/50 border-b border-[var(--border)] px-4 py-2 flex items-center gap-2">
          <Icon name="database" size={14} className="text-[var(--text-secondary)]" />
          <h3 className="text-sm font-bold text-[var(--text-primary)] landing-display">Data Model</h3>
          <span className="ml-auto text-[10px] font-semibold px-2 py-0.5 rounded-full bg-[var(--bg-elevated)] text-[var(--text-secondary)] landing-mono">{tables.length} tables</span>
        </div>
  ...
  return (
    <div id="data-model" className="rounded-2xl overflow-hidden scroll-mt-24 border border-[var(--border)] bg-[var(--bg-surface)]">
      <div className="bg-[var(--bg-elevated)]/50 border-b border-[var(--border)] px-4 py-2 flex items-center justify-between">
        ...
        <button
          onClick={handleCopy}
          className="text-[11px] font-medium px-2.5 py-1 rounded-lg border border-[var(--border)] bg-[var(--bg-surface)] hover:bg-[var(--bg-elevated)] text-[var(--text-secondary)] hover:text-[var(--text-primary)] transition-all landing-mono flex items-center gap-1.5"
        >
          {copied ? (
...
function StaticCloudDiagram({ topicId, provider, staticSrc, diagramData, generatingDiagram, diagramError, onGenerate }) {
  ...
  return (
    <div>
      <div className="rounded-lg overflow-hidden flex items-center justify-center bg-[var(--bg-surface)]">
        <img
          src={staticSrc}
      ...
      <div className="mt-2 flex items-center justify-between text-sm text-[var(--text-muted)] landing-mono">
        ...
        <div className="flex items-center gap-3">
          <button
            onClick={onGenerate}
            className="text-xs text-[var(--text-muted)] hover:text-emerald-500 transition-colors"
            title="Generate a fresh diagram using AI"
          >
            Regenerate →
          </button>
          <a href={staticSrc} target="_blank" rel="noopener noreferrer" className="text-[var(--accent)] hover:text-emerald-500">
            Full Size →
          </a>
        </div>
      </div>
...
export default function TopicDetail({
  ...
  return (
    <div className="landing-root animate-fade-in">
      ...
      <div className="rounded-xl p-3 mb-3 border border-[var(--border)] bg-[var(--bg-surface)] shadow-[0_1px_3px_rgba(0,0,0,0.04)]">
            ...
            <div className="flex items-center gap-2 mb-2 flex-wrap">
              ...
              {topicDetails.difficulty && (
                <span className={`text-[10px] landing-mono px-1.5 py-0.5 rounded border ${
                  topicDetails.difficulty === 'Easy' ? 'bg-[var(--accent)]/10 text-[var(--accent)] border-emerald-500/20' :
      ...
      <div className="flex flex-wrap items-center justify-between gap-2 px-3 py-2.5 rounded-lg mb-2 bg-[var(--bg-elevated)] border border-[var(--border)]">
        <div className="flex items-center gap-2">
          {/* Progress */}
          {progressInfo && (
            <div className="flex items-center gap-1.5 px-2 py-1.5 rounded-lg bg-[var(--bg-surface)] border border-[var(--border)]">
          ...
          <button
            ...
            className={`flex items-center gap-2 px-2 sm:px-3 py-2 rounded-lg text-sm font-medium transition-all landing-body ${completedTopics[selectedTopic] ? 'bg-[var(--accent)]/10 text-[var(--accent)] border border-emerald-500/20' : 'text-[var(--text-primary)] hover:text-[var(--text-primary)] hover:bg-[var(--bg-elevated)] border border-[var(--border)]'}`}
          >
      ...
      {/* ── UNLOCKED CONTENT ── */}
      {!isLocked && showAskAI && (
        <div className="p-3 rounded-xl mb-2 bg-[var(--accent)]/10/50 border border-emerald-500/20">
          ...
          <div className="flex gap-2 mb-2">
            <input
              ...
              className="flex-1 px-3 py-2.5 rounded-lg text-sm text-[var(--text-primary)] placeholder-gray-500 focus:outline-none border border-[var(--border)] bg-[var(--bg-surface)] focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-300 landing-body"
            />
            <button
              onClick={() => handleAskAI()}
      ...
      {!isLocked && activePage === 'eng-blogs' && (
        <div className="space-y-3">
          {/* Overview */}
          {topicDetails.introduction && (
            <div id="overview" className="rounded-xl overflow-hidden scroll-mt-24 border border-[var(--border)]" style={{ background: `linear-gradient(180deg, ${topicDetails.color || '#ef4444'}12 0%, var(--bg-surface) 100%)` }}>
          ...
          {topicDetails.articles && topicDetails.articles.length > 0 && (
            <div id="articles" className="rounded-xl overflow-hidden scroll-mt-24 border border-[var(--border)]">
              <div className="px-4 py-2.5 border-b border-[var(--border)] bg-[var(--bg-surface)]/80 flex items-center gap-2">
                ...
                <h3 className="text-sm font-bold text-[var(--text-primary)] landing-display">Articles</h3>
                <span className="text-[10px] landing-mono text-[var(--text-muted)] bg-[var(--bg-elevated)] px-1.5 py-0.5 rounded">{topicDetails.articles.length}</span>
              </div>
          ...
          {topicDetails.keyQuestions && topicDetails.keyQuestions.length > 0 && (
            <div id="key-questions" className="rounded-xl overflow-hidden scroll-mt-24 border border-[var(--border)]">
              <div className="px-4 py-2.5 border-b border-[var(--border)] bg-[var(--bg-surface)]/80 flex items-center gap-2">
                <Icon name="lightbulb" size={14} className="text-[var(--text-secondary)]" />
                <h3 className="text-sm font-bold text-[var(--text-primary)] landing-display">Key Takeaways</h3>
              </div>
              <div className="divide-y divide-[var(--border)]">
      ...
      {!isLocked && activePage === 'roadmaps' && (
        <div className="space-y-3">
          {/* Overview */}
          {topicDetails.introduction && (
            <div id="overview" className="rounded-xl overflow-hidden scroll-mt-24 border border-[var(--border)]" style={{ background: `linear-gradient(180deg, ${topicDetails.color || '#f59e0b'}12 0%, var(--bg-surface) 100%)` }}>
              <div className="px-4 py-2.5 border-b border-[var(--border)] bg-[var(--bg-surface)]/80 flex items-center gap-2">
                <Icon name="trendingUp" size={14} style={{ color: topicDetails.color || '#f59e0b' }} />
                <h3 className="text-sm font-bold text-[var(--text-primary)] landing-display">Overview</h3>
                <span className="text-[10px] landing-mono text-[var(--text-muted)] bg-[var(--bg-elevated)] px-1.5 py-0.5 rounded">{topicDetails.phases?.length || 0} phases</span>
                <span className="text-[10px] landing-mono text-[var(--text-muted)]">{topicDetails.phases?.reduce((a, p) => a + p.topics.length, 0) || 0} topics total</span>
              </div>
              <div className="p-4">
                <div className="text-[15px] leading-relaxed text-[var(--text-secondary)] landing-body">
          ...
          {topicDetails.phases && topicDetails.phases.length > 0 && (
            <div id="roadmap-phases" className="rounded-xl overflow-hidden scroll-mt-24 border border-[var(--border)]">
              <div className="px-4 py-2.5 border-b border-[var(--border)] bg-[var(--bg-surface)]/80 flex items-center gap-2">
                ...
                <h3 className="text-sm font-bold text-[var(--text-primary)] landing-display">{topicDetails.title} Roadmap</h3>
                <span className="text-[10px] landing-mono text-[var(--text-muted)]">{topicDetails.phases.length} phases, {topicDetails.phases.reduce((a, p) => a + p.topics.length, 0)} topics</span>
              </div>
          ...
          {topicDetails.keyQuestions && topicDetails.keyQuestions.length > 0 && (
            <div id="key-questions" className="rounded-xl overflow-hidden scroll-mt-24 border border-[var(--border)]">
              <div className="px-4 py-2.5 border-b border-[var(--border)] bg-[var(--bg-surface)]/80 flex items-center gap-2">
                <Icon name="messageSquare" size={14} className="text-[var(--text-secondary)]" />
                <h3 className="text-sm font-bold text-[var(--text-primary)] landing-display">FAQ</h3>
              </div>
              <div className="divide-y divide-[var(--border)]">
                {topicDetails.keyQuestions.map((qa, i) => (
                  <div key={i} className="px-4 py-3">
        ...
        <div className="space-y-3">
            ...
            <div className="p-4">
              ...
              <div className="flex items-center gap-2 flex-wrap mb-3">
                <span className={`text-xs landing-mono px-2 py-1 rounded-full font-bold ${
                  topicDetails.difficulty === 'beginner' ? 'bg-emerald-100 text-[var(--accent)]' :
          ...
          {topicDetails.learningObjectives && topicDetails.learningObjectives.length > 0 && (
            <div id="learning-objectives" className="rounded-xl overflow-hidden scroll-mt-24 border border-[var(--border)]">
              <div className="px-4 py-2.5 border-b border-[var(--border)] bg-[var(--bg-surface)]/80 flex items-center gap-2">
                ...
                <h3 className="text-sm font-bold text-[var(--text-primary)] landing-display">What You'll Learn</h3>
              </div>
              <div className="p-4">
          ...
          {topicDetails.keyQuestions && topicDetails.keyQuestions.length > 0 && (
            <div id="key-questions" className="rounded-xl overflow-hidden scroll-mt-24 border border-[var(--border)]">
              <div className="px-4 py-2.5 border-b border-[var(--border)] bg-[var(--bg-surface)]/80 flex items-center gap-2">
                <Icon name="messageSquare" size={14} className="text-[var(--text-secondary)]" />
                <h3 className="text-sm font-bold text-[var(--text-primary)] landing-display">Key Questions</h3>
                <span className="text-[10px] landing-mono text-[var(--text-muted)] bg-[var(--bg-elevated)] px-1.5 py-0.5 rounded">{topicDetails.keyQuestions.length}</span>
              </div>
              <div className="divide-y divide-[var(--border)]">
                {topicDetails.keyQuestions.map((qa, i) => (
                  <div key={i} className="px-4 py-3">
      ...
      {!isLocked && isCodingStyle && topicDetails.keyPatterns && (
        <div className="space-y-3">
          ...
          {topicDetails.introduction && (
            <div id="overview" className="rounded-xl overflow-hidden scroll-mt-24 border border-[var(--border)]" style={{ background: `linear-gradient(180deg, ${topicDetails.color || '#10b981'}12 0%, var(--bg-surface) 100%)` }}>
              <div className="px-4 py-2.5 border-b border-[var(--border)] bg-[var(--bg-surface)]/80 flex items-center gap-2">
                <Icon name="book" size={14} className="text-[var(--accent)]" />
                <h3 className="text-sm font-bold text-[var(--text-primary)] landing-display">Overview</h3>
              </div>
          ...
          {topicDetails.visualizations && topicDetails.visualizations.length > 0 && (
            <div className="rounded-xl overflow-hidden border border-[var(--border)] bg-[var(--bg-surface)]">
              <div className="px-4 py-2.5 border-b border-[var(--border)] flex items-center gap-2">
                ...
                <h3 className="text-sm font-bold text-[var(--text-primary)] landing-display">Visual Explanation</h3>
          ...
          <div id="when-to-use" className={`grid gap-3 scroll-mt-24 ${topicDetails.whenToUse && topicDetails.keyPatterns ? '' : 'grid-cols-1'}`}>
            ...
            {topicDetails.whenToUse && (
              <div className="rounded-xl overflow-hidden border border-[var(--border)] bg-[var(--bg-surface)] shadow-sm">
                <div className="px-4 py-2.5 border-b border-[var(--border)] flex items-center gap-2 bg-[var(--bg-surface)]">
                  <Icon name="target" size={14} className="text-[var(--accent)]" />
                  <h3 className="text-sm font-bold text-[var(--text-primary)] landing-display">When to Use</h3>
                  <span className="ml-auto text-[10px] landing-mono text-[var(--text-muted)] bg-[var(--bg-elevated)] px-1.5 py-0.5 rounded-full">{topicDetails.whenToUse.length}</span>
                </div>
            ...
            {topicDetails.keyPatterns && (
              <div className="rounded-xl overflow-hidden border border-[var(--border)] bg-[var(--bg-surface)] shadow-sm">
                <div className="px-4 py-2.5 border-b border-[var(--border)] flex items-center gap-2 bg-[var(--bg-surface)]">
                  <Icon name="puzzle" size={14} className="text-[var(--text-secondary)]" />
                  <h3 className="text-sm font-bold text-[var(--text-primary)] landing-display">Key Patterns</h3>
                  <span className="ml-auto text-[10px] landing-mono text-[var(--text-muted)] bg-[var(--bg-elevated)] px-1.5 py-0.5 rounded-full">{topicDetails.keyPatterns.length}</span>
                </div>
                <div className="p-3">
            ...
            {topicDetails.approach && (
              <div className="rounded-xl overflow-hidden border border-[var(--border)] bg-[var(--bg-surface)] shadow-sm">
                <div className="px-4 py-2.5 border-b border-[var(--border)] flex items-center gap-2 bg-[var(--bg-surface)]">
                  ...
                  <h3 className="text-sm font-bold text-[var(--text-primary)] landing-display">Step-by-Step Approach</h3>
                  <span className="ml-auto text-[10px] landing-mono text-[var(--text-muted)] bg-[var(--bg-elevated)] px-1.5 py-0.5 rounded-full">{topicDetails.approach.length}</span>
                </div>
                <div className="p-4">
                  <div className="relative">
            ...
            {topicDetails.commonMistakes && (
              <div className="rounded-xl overflow-hidden border border-[var(--border)] bg-[var(--bg-surface)] shadow-sm">
                <div className="px-4 py-2.5 border-b border-[var(--border)] flex items-center gap-2 bg-[var(--bg-surface)]">
                  ...
                  <span className="ml-auto text-[10px] landing-mono text-[var(--text-muted)] bg-[var(--bg-elevated)] px-1.5 py-0.5 rounded-full">{topicDetails.commonMistakes.length}</span>
                </div>
                <div className="p-3 grid grid-cols-1 gap-1.5">
          ...
          {topicDetails.commonProblems && (
            <div id="practice" className="rounded-xl overflow-hidden scroll-mt-24 border border-[var(--border)] bg-[var(--bg-surface)] shadow-sm">
              <div className="px-4 py-2.5 border-b border-[var(--border)] flex items-center gap-2 bg-[var(--bg-surface)]">
                <Icon name="code" size={14} className="text-[var(--accent)]" />
                <h3 className="text-sm font-bold text-[var(--text-primary)] landing-display">Practice Problems</h3>
                <span className="ml-auto text-[10px] landing-mono text-[var(--text-muted)] bg-[var(--bg-elevated)] px-1.5 py-0.5 rounded-full">{topicDetails.commonProblems.length}</span>
              </div>
                ...
                {topicDetails.commonProblems.map((problem, i) => {
                  ...
                  return (
                    <Link
                      key={i}
                      to={href}
                      className={`grid grid-cols-[32px_1fr_64px_72px] items-center px-3 py-2.5 transition-colors cursor-pointer group hover:bg-[var(--accent)]/10/60 ${i % 2 === 0 ? 'bg-[var(--bg-surface)]' : 'bg-[var(--bg-elevated)]/40'} ${i < topicDetails.commonProblems.length - 1 ? 'border-b border-[#f0f0f0]' : ''}`}
                    >
                      ...
                      <span className="flex justify-center">
                        {difficulty ? (
                          <span className={`text-[10px] landing-mono px-1.5 py-0.5 rounded-full border font-medium ${
                            difficulty === 'Easy' ? 'bg-[var(--accent)]/10 text-[var(--accent)] border-emerald-500/20' :
                      ...
                      <span className="flex justify-center">
                        <span className="text-[10px] font-bold text-[var(--accent)] bg-[var(--accent)]/10 border border-emerald-500/20 px-2.5 py-1 rounded-md group-hover:bg-emerald-100 transition-colors landing-mono uppercase tracking-wide">Solve</span>
                      </span>
                    </Link>
                  );
                })}
          ...
          {topicDetails.theoryQuestions && topicDetails.theoryQuestions.length > 0 && (
            <div id="theory" className="rounded-xl overflow-hidden scroll-mt-24 border border-[var(--border)] bg-[var(--bg-surface)] shadow-sm">
              <div className="px-4 py-2.5 border-b border-[var(--border)] flex items-center gap-2 bg-[var(--bg-surface)]">
                <Icon name="bookOpen" size={14} className="text-[var(--text-secondary)]" />
                <h3 className="text-sm font-bold text-[var(--text-primary)] landing-display">Theory Questions</h3>
                <span className="text-[10px] landing-mono text-[var(--text-muted)] bg-[var(--bg-elevated)] px-1.5 py-0.5 rounded-full">{topicDetails.theoryQuestions.length}</span>
                <button
              ...
              <div className="p-3">
                <div className="grid grid-cols-1 gap-2">
                  {topicDetails.theoryQuestions.map((q, i) => {
                    ...
                    return (
                      <div key={i} className={`rounded-lg overflow-hidden bg-[var(--bg-surface)] border border-[var(--border)] hover:border-[#d0d5dd] transition-all ${isExpanded ? `border-l-[3px] ${borderColor}` : ''}`}>
                        <button
                        ...
                        >
                          ...
                          {q.difficulty && (
                            <span className={`text-[10px] landing-mono px-1.5 py-0.5 rounded-full border font-medium flex-shrink-0 ${
                              q.difficulty === 'Easy' ? 'bg-[var(--accent)]/10 text-[var(--accent)] border-emerald-500/20' :
                        ...
                        {isExpanded && q.answer && (
                          <div className="px-3 pb-3 pt-1 border-t border-[var(--border)] bg-[var(--bg-elevated)]/50">
                            <div className="pl-8 text-[var(--text-secondary)] text-sm leading-relaxed bg-[var(--bg-surface)] p-3 rounded-lg border border-[var(--border)] landing-body">
                              {q.answer}
                            </div>
                          </div>
                        )}
          ...
          <div id="tips" className={`grid gap-3 scroll-mt-24 ${topicDetails.tips && topicDetails.interviewTips ? 'grid-cols-2' : 'grid-cols-1'}`}>
            ...
            {topicDetails.tips && (
              <div className="rounded-xl overflow-hidden border border-[var(--border)] bg-[var(--bg-surface)] shadow-sm">
                <div className="px-4 py-2.5 border-b border-[var(--border)] flex items-center gap-2 bg-[var(--bg-surface)]">
                  ...
                  <h3 className="text-sm font-bold text-[var(--text-primary)] landing-display">Tips & Tricks</h3>
                </div>
                <div className="p-3 grid grid-cols-1 gap-1.5">
            ...
            {topicDetails.interviewTips && (
              <div className="rounded-xl overflow-hidden border border-[var(--border)] bg-[var(--bg-surface)] shadow-sm">
                <div className="px-4 py-2.5 border-b border-[var(--border)] flex items-center gap-2 bg-[var(--bg-surface)]">
                  <Icon name="briefcase" size={14} className="text-[var(--text-secondary)]" />
                  <h3 className="text-sm font-bold text-[var(--text-primary)] landing-display">Interview Tips</h3>
                  <span className="text-[10px] font-bold text-[var(--text-secondary)] bg-[var(--bg-elevated)] border border-[var(--border)] px-1.5 py-0.5 rounded-full landing-mono ml-auto">PRO</span>
                </div>
                <div className="p-3 grid grid-cols-1 gap-1.5">
            ...
            <>
              ...
              {(topicDetails.introduction || (topicDetails.concepts && !topicDetails.introduction)) && (
                <div className={`grid gap-2 ${topicDetails.introduction && topicDetails.concepts ? '' : 'grid-cols-1'}`}>
                  {topicDetails.introduction && (
                    <div id="overview" className="rounded-2xl overflow-hidden scroll-mt-24 border border-[var(--border)]" style={{ background: 'linear-gradient(180deg, rgba(16,185,129,0.08) 0%, var(--bg-surface) 100%)' }}>
              ...
              <div id="requirements" className={`grid gap-2 scroll-mt-24 ${(topicDetails.functionalRequirements || topicDetails.requirements) && topicDetails.nonFunctionalRequirements ? 'grid-cols-1 lg:grid-cols-2' : 'grid-cols-1'}`}>
                ...
                <div className="rounded-2xl overflow-hidden border border-[var(--border)] bg-[var(--bg-surface)]">
                  <div className="bg-[var(--accent)]/10/50 border-b border-[var(--border)] px-4 py-2 flex items-center gap-2">
                    <Icon name="check" size={14} className="text-[var(--accent)]" />
                    <h3 className="text-sm font-bold text-emerald-800 landing-display">Functional Requirements</h3>
                    <span className="ml-auto text-[10px] font-semibold px-2 py-0.5 rounded-full bg-emerald-100 text-[var(--accent)] landing-mono">{(topicDetails.functionalRequirements || topicDetails.requirements).length} requirements</span>
                  </div>
                  <div className="p-2.5">
                    <div className="grid grid-cols-1 gap-1.5">
                      {(topicDetails.functionalRequirements || topicDetails.requirements).map((req, i) => (
                        <div key={i} className="flex items-start gap-2.5 px-3 py-2.5 rounded-xl border border-transparent bg-[var(--bg-elevated)] hover:border-emerald-500/20 hover:bg-[var(--accent)]/10/40 hover:shadow-sm transition-all cursor-default">
                          <span className="w-5 h-5 rounded-md flex items-center justify-center flex-shrink-0 bg-emerald-100 text-[var(--accent)] mt-0.5">
                ...
                {topicDetails.nonFunctionalRequirements && (
                  <div className="rounded-2xl overflow-hidden border border-[var(--border)] bg-[var(--bg-surface)]">
                    <div className="px-4 py-2 border-b border-[var(--border)] flex items-center gap-2 bg-[var(--bg-elevated)]/50">
                      <Icon name="zap" size={14} className="text-[var(--text-secondary)]" />
                      <h3 className="text-sm font-bold text-[var(--text-primary)] landing-display">Non-Functional Requirements</h3>
                      <span className="ml-auto text-[10px] font-semibold px-2 py-0.5 rounded-full bg-[var(--bg-elevated)] text-[var(--text-secondary)] landing-mono">{topicDetails.nonFunctionalRequirements.length} requirements</span>
                    </div>
                    <div className="p-2.5">
                      <div className="grid grid-cols-1 gap-1.5">
              ...
              {(topicDetails.apiDesign?.endpoints || topicDetails.dataModel) && (
                <div className={`grid gap-2 scroll-mt-24 ${topicDetails.apiDesign?.endpoints && topicDetails.dataModel ? '' : 'grid-cols-1'}`}>
                  ...
                  {topicDetails.apiDesign && topicDetails.apiDesign.endpoints && (
                    <div id="api-design" className="rounded-2xl overflow-hidden scroll-mt-24 border border-[var(--border)] bg-[var(--bg-surface)]">
                      <div className="bg-[var(--bg-elevated)]/50 border-b border-[var(--border)] px-4 py-2 flex items-center gap-2">
                        ...
                        <span className="ml-auto text-[10px] font-semibold px-2 py-0.5 rounded-full bg-[var(--bg-elevated)] text-[var(--text-secondary)] landing-mono">{topicDetails.apiDesign.endpoints.length} endpoints</span>
                      </div>
                      <div className="p-3">
                        <div className="grid grid-cols-1 gap-2">
                          {topicDetails.apiDesign.endpoints.map((endpoint, i) => (
                            <div key={i} className="rounded-xl p-3.5 bg-[var(--bg-surface)] border border-[var(--border)] hover:shadow-md hover:border-[#d0d5dd] hover:-translate-y-0.5 transition-all">
                              <div className="flex items-center gap-2.5 mb-2">
                                <span className={`text-[11px] landing-mono px-2.5 py-1 rounded-full font-bold uppercase tracking-wide ${
                                  endpoint.method === 'GET' ? 'bg-emerald-100 text-[var(--accent)] border border-emerald-500/20' :
                              ...
                              {endpoint.response && (
                                <div className="rounded-lg bg-[#f6f8fa] border border-[var(--border)] px-3 py-2 overflow-x-auto">
              ...
              {topicDetails.keyQuestions && (
                <div id="key-questions" className="rounded-2xl overflow-hidden scroll-mt-24 border border-[var(--border)] bg-[var(--bg-surface)]">
                  <div className="bg-[var(--bg-elevated)]/50 border-b border-[var(--border)] px-4 py-2 flex items-center gap-2">
                    <Icon name="messageSquare" size={14} className="text-[var(--accent)]" />
                    <h3 className="text-sm font-bold text-[var(--text-primary)] landing-display">Key Questions</h3>
                    <span className="text-[10px] font-semibold px-2 py-0.5 rounded-full bg-[var(--accent)]/10 text-[var(--accent)] landing-mono">{topicDetails.keyQuestions.length} topics</span>
                    <button
                      onClick={() => {
                        if (sdAllQsExpanded) {
                          setSdExpandedQs({});
                  ...
                  <div className="p-2.5 space-y-1.5">
                    {topicDetails.keyQuestions.map((q, i) => {
                      ...
                      return (
                        <div key={i} className={`rounded-xl overflow-hidden border transition-all ${isOpen ? 'border-emerald-500/20 shadow-sm' : 'border-[var(--border)] hover:border-[#d0d5dd]'}`}>
                          <button
                          ...
                          {isOpen && (
                            <div className="px-4 pb-4 pt-1 border-t border-[var(--border)]" style={{ borderLeft: '3px solid #10b981' }}>
              ...
              {(topicDetails.basicImplementation || topicDetails.advancedImplementation) && (
                <div id="architecture" className={`grid gap-2 scroll-mt-24 ${topicDetails.basicImplementation && topicDetails.advancedImplementation ? 'grid-cols-1 lg:grid-cols-2' : 'grid-cols-1'}`}>
                  ...
                  {topicDetails.advancedImplementation && (
                    <div className="rounded-2xl overflow-hidden border border-emerald-500/20 bg-[var(--bg-surface)]">
                      <div className="border-b border-emerald-500/20 px-4 py-2 flex items-center gap-2 bg-[var(--accent)]/10/60">
                        <span className="text-[10px] font-bold px-2.5 py-0.5 rounded-full bg-emerald-100 text-[var(--accent)] uppercase tracking-wider landing-mono">Advanced</span>
                      ...
                      <div className="p-4">
                        ...
                        {topicDetails.advancedImplementation.architecture && !topicDetails.advancedImplementation.svgTemplate && (
                          <div className="rounded-xl overflow-hidden mb-3 border border-emerald-500/20">
                            <div className="px-3 py-1.5 bg-[var(--accent)]/10 border-b border-emerald-500/20 flex items-center gap-2">
                            ...
                            <div className="bg-[#f6f8fa] overflow-x-auto border-[var(--border)]">
                              <pre
                          ...
                          <div className="mb-3">
                            ...
                            <div className="grid grid-cols-1 gap-1.5">
                              {topicDetails.advancedImplementation.keyPoints.map((point, i) => (
                                <div key={i} className="flex items-start gap-2.5 px-3 py-2 rounded-lg bg-[var(--accent)]/10/50 border border-emerald-100 text-sm landing-body">
                        ...
                        {(topicDetails.advancedImplementation.databaseChoice || topicDetails.advancedImplementation.caching) && (
                          <div className="flex flex-wrap gap-2">
                            {topicDetails.advancedImplementation.databaseChoice && (
                              <span className="text-[10px] landing-mono px-2 py-1 rounded-lg border bg-[var(--accent)]/10 text-[var(--accent)] border-emerald-500/20 font-semibold">
              ...
              <div className={`grid gap-2 ${isSDStyle ? '' : 'grid-cols-1'}`}>
                ...
                {isSDStyle && topicDetails && (
                  <div className="rounded-xl overflow-hidden border border-[var(--border)] bg-[var(--bg-surface)]">
                    <div className="bg-[var(--accent)]/10/50 border-b border-[var(--border)] px-3 py-2 flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        <Icon name="layers" size={14} className="text-[var(--accent)]" />
                        <h3 className="text-sm font-bold text-[var(--text-primary)] landing-display">Architecture Diagram</h3>
                      </div>
                      <div className="flex items-center gap-2">
                      ...
                      {isAdmin && (
                        <div className="flex items-center gap-2 ml-2 pl-2 border-l border-[var(--border)]">
                          <button
                            ...
                            className="px-2 py-0.5 text-[10px] font-mono font-bold rounded bg-[var(--bg-elevated)] text-[var(--text-secondary)] hover:bg-emerald-100 hover:text-[var(--accent)] transition-colors border border-[var(--border)]"
                          ...
                          {adminRegenStatus && (
                            <span className="text-[10px] font-mono text-[var(--text-muted)]">{adminRegenStatus}</span>
                          )}
                        </div>
                      )}
                    </div>
                ...
                {topicDetails.tips && (
                  <div className="rounded-lg overflow-hidden border border-[var(--border)] bg-[var(--bg-surface)]">
                    <div className="px-3 py-2 border-b border-[var(--border)] flex items-center gap-2 bg-[var(--accent)]/10/50">
              ...
              {(topicDetails.createFlow || topicDetails.redirectFlow) && (
                <div className="grid grid-cols-1 gap-2">
                  ...
                  {topicDetails.createFlow && (
                    <div className="rounded-lg overflow-hidden border border-[var(--border)] bg-[var(--bg-surface)]">
                      <div className="px-3 py-2 border-b border-[var(--border)] flex items-center gap-2 bg-[var(--bg-elevated)]">
                        <Icon name="arrowRight" size={16} className="text-[var(--accent)]" />
                  ...
                  {topicDetails.redirectFlow && (
                    <div className="rounded-lg overflow-hidden border border-[var(--border)] bg-[var(--bg-surface)]">
                      <div className="px-3 py-2 border-b border-[var(--border)] flex items-center gap-2 bg-[var(--bg-elevated)]">
                        <Icon name="arrowLeft" size={16} className="text-[var(--accent)]" />
                ...
                <div className="rounded-2xl overflow-hidden bg-[var(--bg-surface)] border border-[var(--border)]">
                  ...
                  <div className="p-2.5 space-y-2">
                    {topicDetails.discussionPoints.map((point, i) => {
                      ...
                      return (
                        <div key={i} className="rounded-xl border border-[var(--border)] bg-[var(--bg-surface)] hover:border-[#d0d5dd] transition-all overflow-hidden">
              ...
              {topicDetails.architectureLayers && (
                <div className="rounded-lg overflow-hidden border border-[var(--border)] bg-[var(--bg-surface)]">
                  <div className="px-3 py-2 border-b border-[var(--border)] flex items-center gap-2 bg-teal-50">
              ...
              {topicDetails.deepDiveTopics && (
                <div className="rounded-lg overflow-hidden border border-[var(--border)] bg-[var(--bg-surface)]">
                  <div className="px-3 py-2 border-b border-[var(--border)] flex items-center gap-2 bg-sky-50">
              ...
              {topicDetails.edgeCases && (
                <div className="rounded-2xl overflow-hidden bg-[var(--bg-surface)] border border-[var(--border)]">
                  <div className="px-4 py-2 border-b border-[var(--border)] flex items-center gap-2 bg-red-50/50">
                  ...
                  <div className="p-2.5 space-y-2">
                    {topicDetails.edgeCases.map((ec, i) => (
                      <div key={i} className="rounded-xl border border-[var(--border)] bg-[var(--bg-surface)] hover:border-red-200 transition-all overflow-hidden">
                        <div className="px-4 py-3">
                          ...
                          <div className="ml-8 mt-2 px-3 py-2 rounded-lg bg-[var(--accent)]/10 border border-emerald-100">
                ...
                <div className="rounded-2xl overflow-hidden bg-[var(--bg-surface)] border border-[var(--border)]">
                  ...
                  <div className="p-2.5 space-y-2">
                    {topicDetails.tradeoffs.map((t, i) => (
                      <div key={i} className="rounded-xl border border-[var(--border)] bg-[var(--bg-surface)] hover:border-[var(--border)] transition-all overflow-hidden">
                        <div className="px-4 py-3">
                          <div className="flex items-center gap-2.5 mb-2">
                            <span className="w-6 h-6 rounded-lg flex items-center justify-center flex-shrink-0 bg-[var(--bg-elevated)] border border-amber-100">
                          ...
                          <div className="ml-8 grid grid-cols-1 sm:grid-cols-2 gap-2">
                            <div className="px-3 py-2 rounded-lg bg-[var(--accent)]/10 border border-emerald-100">
                    ...
                    {topicDetails.layeredDesign.map((layer, i) => {
                      ...
                      return (
                        <div key={i} className="relative">
                          ...
                          <div className="rounded-xl border border-[var(--border)] bg-[var(--bg-surface)] hover:border-[var(--border)] transition-all overflow-hidden">
                            <div className="px-4 py-3">
                              <div className="flex items-center gap-2.5 mb-1.5">
              ...
              {topicDetails.interviewFollowups && (
                <div className="rounded-lg overflow-hidden border border-[var(--border)] bg-[var(--bg-surface)]">
                  <div className="px-3 py-2 border-b border-[var(--border)] flex items-center gap-2 bg-orange-50">
                      ...
                      <div className="p-3">
                        <div className="flex flex-wrap gap-2">
                          {topicDetails.components.map((comp, i) => (
                            <span key={i} className="text-[10px] landing-mono px-2 py-1 rounded-lg border bg-[var(--accent)]/10 text-[var(--accent)] border-emerald-500/20 font-semibold">
                              {comp}
                            </span>
                          ))}
                        </div>
                  ...
                  {topicDetails.keyDecisions && (
                    <div className="rounded-2xl overflow-hidden bg-[var(--bg-surface)] border border-[var(--border)]">
                      <div className="px-4 py-2 border-b border-[var(--border)] flex items-center gap-2 bg-[var(--accent)]/10/50">
                        ...
                        <span className="ml-auto text-[10px] font-semibold px-2 py-0.5 rounded-full bg-emerald-100 text-[var(--accent)] landing-mono">{topicDetails.keyDecisions.length}</span>
                      </div>
                      <div className="p-3">
                        <div className="flex flex-nowrap gap-2.5 overflow-x-auto pb-2" style={{ scrollbarWidth: 'thin' }}>
                          {topicDetails.keyDecisions.map((decision, i) => (
                            <div key={i} className="flex-shrink-0 w-56 p-3.5 rounded-xl border border-[var(--border)] bg-[var(--bg-elevated)] hover:border-emerald-500/20 hover:shadow-sm transition-all">
                              <div className="flex items-center gap-2 mb-2">
                ...
                <div className="rounded-lg overflow-hidden bg-[var(--bg-elevated)] border border-[var(--border)]">
                  ...
                  <div className="p-4 grid  gap-2">
                    {topicDetails.structures.map((struct, i) => (
                      <div key={i} className="flex items-start gap-2 p-3 rounded-lg bg-[var(--bg-surface)] border border-[var(--border)]">
        ...
        <div className="space-y-3">
          ...
          {(topicDetails.introduction || topicDetails.principles?.length > 0) && (
            <div className={`grid gap-2 ${topicDetails.introduction && topicDetails.principles?.length > 0 ? '' : 'grid-cols-1'}`}>
              ...
              {topicDetails.introduction && (() => {
                ...
                return (
                  <div id="overview" className="scroll-mt-24 rounded-2xl border border-[var(--border)] overflow-hidden" style={{ background: 'linear-gradient(180deg, rgba(16,185,129,0.06) 0%, var(--bg-surface) 100%)' }}>
                    <div className="px-4 py-2 border-b border-[var(--border)] bg-[var(--accent)]/10/60 flex items-center gap-2">
                      <Icon name="book" size={14} className="text-[var(--accent)]" />
            ...
            <div id="key-questions" className="rounded-2xl overflow-hidden scroll-mt-24 border border-[var(--border)] bg-[var(--bg-surface)]">
              ...
              <div className="p-2.5 space-y-2">
                {topicDetails.keyQuestions.map((item, index) => {
                  ...
                  return (
                    <div key={index} className="rounded-xl overflow-hidden border border-[var(--border)] bg-[var(--bg-surface)] hover:border-[#d0d5dd] hover:shadow-sm transition-all">
                          ...
                          {(() => {
                            ...
                            const renderLine = (t, i) => {
                              if (t.startsWith('\u2705') || t.startsWith('\u274C')) {
                                ...
                                return <div key={i} className="flex items-start gap-2 mb-1"><span className={`w-4 h-4 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5 ${ok ? 'bg-emerald-100' : 'bg-red-100'}`}><svg className={`w-2.5 h-2.5 ${ok ? 'text-[var(--accent)]' : 'text-red-500'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={3}>{ok ? <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" /> : <path strokeLinecap="round" strokeLinejoin="round" d="M6 18L18 6M6 6l12 12" />}</svg></span><span className="text-sm landing-body">{t.substring(2).trim()}</span></div>;
                              }
                            ...
                            const renderBlock = (block, bi) => {
                              ...
                              if (block.type === 'star') {
                                ...
                                if (sm) {
                                  ...
                                  const starBgs = { Situation: 'rgba(59,130,246,0.08)', Task: 'rgba(139,92,246,0.08)', Action: 'rgba(16,185,129,0.08)', Result: 'rgba(245,158,11,0.08)' };
                              ...
                              return <div key={bi} className="rounded-xl overflow-hidden" style={{ background: 'var(--bg-surface)', border: '1px solid var(--border)', borderLeft: `4px solid ${topicDetails.color}` }}>
                                <div className="px-4 py-3">
                                  <div className="flex items-center gap-2.5">
                                    {numMatch
          ...
          {topicDetails.starExample && (
            <div id="star-example" className="rounded-2xl overflow-hidden scroll-mt-24 border border-[var(--border)] bg-[var(--bg-surface)]">
              <div className="px-4 py-2 border-b border-[var(--border)] flex items-center gap-2" style={{ background: 'linear-gradient(135deg, rgba(59,130,246,0.08) 0%, rgba(16,185,129,0.08) 50%, rgba(239,68,68,0.06) 100%)' }}>
          ...
          {topicDetails.exampleResponse && (
            <div id="example-response" className="rounded-2xl overflow-hidden scroll-mt-24 border border-[var(--border)] bg-[var(--bg-surface)]">
              <div className="px-4 py-2 border-b border-[var(--border)] flex items-center gap-2 bg-[var(--accent)]/10/50">
                ...
                <span className="ml-auto text-[10px] font-semibold px-2 py-0.5 rounded-full bg-emerald-100 text-[var(--accent)] landing-mono">Ready to use</span>
              </div>
              <div className="p-5">
          ...
          {topicDetails.tips && (
            <div id="tips" className="rounded-2xl overflow-hidden scroll-mt-24 border border-[var(--border)] bg-[var(--bg-surface)]">
              <div className="px-4 py-2 border-b border-[var(--border)] flex items-center gap-2 bg-[var(--accent)]/10/50">
                ...
                <span className="ml-auto text-[10px] font-semibold px-2 py-0.5 rounded-full bg-emerald-100 text-[var(--accent)] landing-mono">{topicDetails.tips.length} tips</span>
              </div>
              <div className="p-2.5 space-y-1.5">
                {topicDetails.tips.map((tip, i) => (
                  <div key={i} className="flex items-start gap-2.5 px-3.5 py-3 rounded-xl bg-[var(--accent)]/10/40 border border-emerald-100 hover:bg-[var(--accent)]/10/70 hover:border-emerald-500/20 hover:shadow-sm transition-all group">
        ...
        <div className="mt-6 pt-4 border-t border-[var(--border)] flex items-stretch gap-3">
          {prevTopic ? (
            <button
              ...
              className="flex-1 flex items-center gap-3 px-4 py-3 rounded-xl border border-[var(--border)] bg-[var(--bg-surface)] hover:border-emerald-300 hover:bg-[var(--accent)]/10/30 transition-all group text-left"
            >
          ...
          {nextTopic ? (
            <button
              ...
              className="flex-1 flex items-center justify-end gap-3 px-4 py-3 rounded-xl border border-[var(--border)] bg-[var(--bg-surface)] hover:border-emerald-300 hover:bg-[var(--accent)]/10/30 transition-all group text-right"
            >
              <div className="min-w-0">
