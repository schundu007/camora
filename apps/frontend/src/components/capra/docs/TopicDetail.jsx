    ...
    <div className="landing-root animate-fade-in">
      ...
      {isCodingStyle && topicDetails.keyPatterns && (
        <div className="space-y-3">
          ...
          <div id="when-to-use" className={`grid gap-2 scroll-mt-24 ${topicDetails.whenToUse && topicDetails.keyPatterns ? 'grid-cols-1' : 'grid-cols-1'}`}>
            {/* When to Use */}
          ...
          <div id="approach" className={`grid gap-2 scroll-mt-24 ${topicDetails.approach && topicDetails.commonMistakes ? 'grid-cols-1' : 'grid-cols-1'}`}>
          ...
          <div className={`grid gap-2 ${topicDetails.commonProblems && topicDetails.theoryQuestions?.length > 0 ? 'grid-cols-1' : 'grid-cols-1'}`}>
          ...
          <div id="tips" className={`grid gap-2 scroll-mt-24 ${topicDetails.tips && topicDetails.interviewTips ? 'grid-cols-1' : 'grid-cols-1'}`}>
            {/* Tips */}
            {topicDetails.tips && (
              <div className="rounded-lg overflow-hidden border border-[#e3e8ee] bg-white">
                <div className="px-3 py-1.5 border-b border-[#e3e8ee] flex items-center gap-2 bg-emerald-50/50">
          ...
          {(topicDetails.requirements || topicDetails.functionalRequirements || topicDetails.introduction || topicDetails.concepts) && (
            <>
              ...
              {(topicDetails.introduction || (topicDetails.concepts && !topicDetails.introduction)) && (
                <div className={`grid gap-2 ${topicDetails.introduction && topicDetails.concepts ? 'grid-cols-1' : 'grid-cols-1'}`}>
                  {topicDetails.introduction && (
              ...
              <div id="requirements" className="grid grid-cols-1 gap-2 scroll-mt-24">
              ...
              {(topicDetails.apiDesign?.endpoints || topicDetails.dataModel) && (
                <div className={`grid gap-2 scroll-mt-24 ${topicDetails.apiDesign?.endpoints && topicDetails.dataModel ? 'grid-cols-1' : 'grid-cols-1'}`}>
              ...
              {(topicDetails.basicImplementation || topicDetails.advancedImplementation) && (
                <div id="architecture" className={`grid gap-2 scroll-mt-24 ${topicDetails.basicImplementation && topicDetails.advancedImplementation ? 'grid-cols-1' : 'grid-cols-1'}`}>
              ...
              <div className={`grid gap-2 ${isSDStyle ? 'grid-cols-1' : 'grid-cols-1'}`}>
              ...
              {(!topicDetails.introduction && topicDetails.components) || topicDetails.keyDecisions ? (
                <div className={`grid gap-2 ${(!topicDetails.introduction && topicDetails.components) && topicDetails.keyDecisions ? 'grid-cols-1' : 'grid-cols-1'}`}>
                  {/* System Components */}
      ...
      {(activePage === 'behavioral' || (activePage === 'low-level' && !topicDetails.coreEntities && !topicDetails.implementation && !topicDetails.functionalRequirements)) && (topicDetails.sampleQuestions || topicDetails.starExample || topicDetails.introduction || topicDetails.keyQuestions) && (
        <div className="space-y-3">
          ...
          {(topicDetails.introduction || topicDetails.principles?.length > 0) && (
            <div className={`grid gap-2 ${topicDetails.introduction && topicDetails.principles?.length > 0 ? 'grid-cols-1' : 'grid-cols-1'}`}>
              {/* Introduction */}
              {topicDetails.introduction && (() => {
          ...
          {(topicDetails.starExample || topicDetails.exampleResponse) && (
            <div className={`grid gap-2 ${topicDetails.starExample && topicDetails.exampleResponse ? 'grid-cols-1' : 'grid-cols-1'}`}>
          ...
          {(topicDetails.sampleQuestions?.length > 0 || topicDetails.tips) && (
            <div className={`grid gap-2 ${topicDetails.sampleQuestions?.length > 0 && topicDetails.tips ? 'grid-cols-1' : 'grid-cols-1'}`}>
