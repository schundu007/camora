      ...
      <div className="flex items-start gap-2.5">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex flex-wrap gap-1">
            <span className="text-[9px] landing-mono px-1.5 py-0.5 rounded bg-emerald-50 text-[var(--accent)] border border-emerald-200">
...
export function StaticDiagramGrid({ diagrams, title = 'Architecture Diagrams' }) {
  return (
    <div className="space-y-2">
      ...
      <div className={`grid gap-3 ${diagrams.length === 1 ? 'grid-cols-1' : 'grid-cols-1'}`}>
        {diagrams.map((d) => (
