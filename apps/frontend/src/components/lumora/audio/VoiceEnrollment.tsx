      ...
      <div className="flex flex-col gap-2 shrink-0">
        <button
          ...
          style={isLight ? {
            ...
            background: isRecording ? '#FF0000' : '#F97316',
            border: 'none',
          } : {
            fontSize: '11px',
    ...
    <div className={isLight ? 'flex flex-col gap-2 shrink-0' : 'flex items-center gap-1 shrink-0'}>
      <button
        ...
        style={isLight ? {
          ...
          padding: '10px 16px',
          color: '#ffffff',
          background: voiceFilterEnabled ? '#F97316' : '#000000',
          border: 'none',
        } : {
          fontSize: '11px',
          padding: '4px 8px',
          color: voiceFilterEnabled ? '#FB923C' : 'rgba(255,255,255,0.6)',
          background: voiceFilterEnabled ? 'rgba(249,115,22,0.08)' : 'transparent',
          border: '1px solid rgba(255,255,255,0.08)',
        }}
