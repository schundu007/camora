...
export function MicrophoneSelector({ disabled, onDeviceChange }: MicrophoneSelectorProps) {
  ...
  return (
    <select
      ...
      className="appearance-none bg-gray-800 border border-gray-600 text-white font-bold text-sm px-1.5 py-1 min-h-[36px] w-[100px] sm:w-[120px] truncate focus:outline-none focus:ring-1 focus:ring-indigo-500 disabled:opacity-50 cursor-pointer rounded"
      style={{
