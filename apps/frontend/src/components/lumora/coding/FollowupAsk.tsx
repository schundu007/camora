...
export default function FollowupAsk({ problem, activeSolutionName, activeSolutionCode, token }: FollowupAskProps) {
  ...
  return (
    <div className="rounded-xl overflow-hidden" style={{ background: '#FFFFFF', border: '1px solid #E2E8F0' }}>
      <div className="flex items-center gap-2 px-3 py-2" style={{ background: 'rgba(6,78,59,0.05)', borderBottom: '1px solid rgba(6,78,59,0.12)' }}>
      ...
      <div className="p-3 space-y-2">
        ...
        {(answer || loading) && (
          <div className="rounded-lg px-2.5 py-2" style={{ background: 'rgba(6,78,59,0.04)', border: '1px solid rgba(6,78,59,0.15)' }}>
