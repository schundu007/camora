      ...
      >
        ...
        >
          <div className="flex items-center gap-2">
            <svg className="w-4 h-4 text-[#60A5FA]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5}>
        ...
        <div className="mx-3 mb-2">
          <div className="flex items-center gap-1.5 mb-1.5">
            <svg className="w-3 h-3 text-[#60A5FA]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}>
            ...
            <span className="text-[10px] font-mono font-bold text-[#60A5FA] uppercase tracking-widest">AI Answer Stream</span>
            {isStreaming && (
