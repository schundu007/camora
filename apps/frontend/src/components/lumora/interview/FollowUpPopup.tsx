        ...
        return (
          <div
            ...
            style={{
              ...
              background: active
                ? `rgba(236,72,153,${0.4 + barOpacities[i] * 0.6})`
...
function SayThisCard({ text }: { text: string | null }) {
  ...
  return (
    <div
      ...
      style={{
        background: 'linear-gradient(135deg, rgba(236,72,153,0.15), rgba(139,92,246,0.10))',
        border: '1px solid rgba(236,72,153,0.25)',
      }}
    >
      <div className="flex items-center justify-between mb-1.5">
        <div className="flex items-center gap-1.5">
          <svg className="w-3.5 h-3.5 text-[#FBCFE8]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      ...
      >
        ...
        >
          <div className="flex items-center gap-2">
            <svg className="w-4 h-4 text-[#FBCFE8]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5}>
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="flex items-center gap-1.5 px-2 py-0.5 rounded-full text-[10px] font-mono font-bold tracking-wider"
              style={{ background: 'rgba(16,185,129,0.12)', color: '#FBCFE8' }}>
        ...
        <div className="mx-3 mb-2">
          <div className="flex items-center gap-1.5 mb-1.5">
            <svg className="w-3 h-3 text-[#FBCFE8]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}>
            ...
            <span className="text-[10px] font-mono font-bold text-[#FBCFE8] uppercase tracking-widest">AI Answer Stream</span>
            {isStreaming && (
