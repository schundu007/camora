        ...
        <div className="flex-1 flex items-center justify-center px-3 min-w-0">
          ...
          {inputValue && (
            <button
              ...
              style={{ background: 'linear-gradient(135deg, #2D8CFF, #2D8CFF)', boxShadow: '0 2px 12px rgba(45,140,255,0.3)' }}
            >
    ...
    <div className="relative">
      ...
      >
        {user.image ? (
          ...
          <div className="w-6 h-6 rounded-full flex items-center justify-center text-white text-[9px] font-bold" style={{ background: 'linear-gradient(135deg, #2D8CFF, #2D8CFF)' }}>
            {initials}
          </div>
        )}
      ...
      {showMenu && (
        <>
          ...
          <div className="absolute right-0 top-full mt-1 w-48 rounded-2xl shadow-xl border z-50 py-1 overflow-hidden" style={{ background: 'linear-gradient(180deg, #2D8CFF 0%, #111111 100%)', borderColor: 'rgba(255,255,255,0.12)' }}>
