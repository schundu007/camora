            ...
            {lines.map((line, i) => {
              ...
              return (
                <div key={i} className="flex items-start gap-3">
                  <span className="flex items-center justify-center w-5 h-5 rounded-md bg-[rgba(34,211,238,0.15)] text-[#67E8F9] text-[10px] font-bold shrink-0 mt-0.5 font-mono">{i + 1}</span>
        ...
        <div className="rounded-xl overflow-hidden animate-fade-up group" style={{...style, background: '#F8FAFC', border: '1px solid #E2E8F0'}}>
          <div className="flex items-center justify-between px-4 py-2 border-b border-slate-200">
            <div className="flex items-center gap-2">
              ...
              <span className="font-mono text-[10px] font-bold text-[#67E8F9]/80 uppercase tracking-widest">{lang}</span>
            </div>
    ...
    <div className="space-y-4">
      {pairs.map((pair, i) => (
        <div key={i}>
          ...
          <div className="ml-9 border-l-2 border-[rgba(34,211,238,0.3)] pl-4 py-1">
