    ...
    <div style={{ ...base, background: 'linear-gradient(135deg, #EFF6FF 0%, #F0F9FF 100%)' }}>
      <div
        style={{
          ...
          top: 0,
          height: '48px',
          background: 'linear-gradient(180deg, transparent, rgba(230,57,70,0.15), transparent)',
        ...
        {bars.map((_, i) => (
          <span
            ...
            style={{
              ...
              height: '100%',
              borderRadius: 2,
              background: `linear-gradient(180deg, ${ACCENT}, #FF6B7A)`,
          ...
          {skills.map((s, i) => (
            <span
              ...
              style={{
                ...
                color: ACCENT,
                border: '1px solid rgba(230,57,70,0.33)',
                opacity: 0,
      ...
      >
        <div
          style={{
            ...
            boxShadow: '0 2px 8px rgba(230,57,70,0.27)',
            marginBottom: 4,
          }}
        />
        {skills.map((s, i) => (
