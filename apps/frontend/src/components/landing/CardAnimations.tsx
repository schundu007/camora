    ...
    <div style={{ ...base, background: 'linear-gradient(135deg, #EFF6FF 0%, #F0F9FF 100%)' }}>
      <div
        style={{
          ...
          top: 0,
          height: '48px',
          background: 'linear-gradient(180deg, transparent, rgba(6,78,59,0.15), transparent)',
        ...
        {bars.map((_, i) => (
          <span
            ...
            style={{
              ...
              height: '100%',
              borderRadius: 2,
              background: `linear-gradient(180deg, ${ACCENT}, #047857)`,
          ...
          {skills.map((s, i) => (
            <span
              ...
              style={{
                ...
                color: ACCENT,
                border: '1px solid rgba(6,78,59,0.33)',
                opacity: 0,
      ...
      >
        <div
          style={{
            ...
            boxShadow: '0 2px 8px rgba(6,78,59,0.27)',
            marginBottom: 4,
          }}
        />
        {skills.map((s, i) => (
          <span
            ...
            style={{
              ...
              background: '#FFFFFF',
              color: ACCENT,
              border: '1px solid rgba(6,78,59,0.27)',
