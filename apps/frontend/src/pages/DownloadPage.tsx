            ...
            <div className="flex justify-center mb-8">
              <div
                style={{
                  ...
                  height: 80,
                  borderRadius: 20,
                  background: 'linear-gradient(135deg, #76B900 0%, #76B900 50%, #10b981 100%)',
                  display: 'flex',
                  alignItems: 'center',
              ...
              {subscriptionLoading ? (
                ...
                <>
                  <a
                    ...
                    style={{
                      background: 'linear-gradient(135deg, #76B900 0%, #76B900 100%)',
                      color: '#ffffff',
              ...
              return (
                <FadeInSection key={p.id} delay={0.1 * i}>
                  ...
                  >
                    ...
                    {/* OS icon */}
                    <div className="mt-2 mb-4" style={{ color: isRecommended ? '#76B900' : 'rgba(255,255,255,0.5)' }}>
                    ...
                    {isPaid ? (
                      <a
                        ...
                        style={{
                          background: isRecommended
                            ? 'linear-gradient(135deg, #76B900, #76B900)'
                      ...
                      <div className="flex items-center gap-2">
                        <button onClick={handleMonthlyAddon} disabled={addonLoading}
                          ...
                          style={{ background: 'linear-gradient(135deg, #76B900, #76B900)', color: '#fff' }}>
