      ...
      <div className="w-full max-w-md bg-white rounded-2xl shadow-lg p-8 md:p-10" style={{ border: '1px solid #e3e8ee' }}>
        ...
        <div className="flex justify-center mb-6">
          <Link to="/" className="inline-flex items-center gap-2.5">
            <div className="w-9 h-9 bg-emerald-500 flex items-center justify-center shadow-lg shadow-emerald-500/20"
                 style={{ clipPath: 'polygon(50% 0%, 100% 25%, 100% 75%, 50% 100%, 0% 75%, 0% 25%)' }}>
              <span className="text-xs font-black text-white">C</span>
            </div>
            <span className="text-lg font-bold tracking-tight text-gray-900" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>Camora</span>
          </Link>
        </div>

        {/* Heading */}
        <h1 className="text-2xl font-bold text-black tracking-tight text-center" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
          Create your account
        </h1>
        ...
        <form onSubmit={handleSubmit} className="mt-7 space-y-4">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1.5">
              Select your target role <span className="text-red-500">*</span>
            </label>
            <select
              value={role}
          ...
          <div>
            ...
            >
              ...
              {resumeFile ? (
                ...
                <>
                  ...
                  <span className="text-sm text-gray-500">{skipResume ? 'Skipped for free tier' : 'Drop your resume or click to browse'}</span>
            ...
            <label className="flex items-center gap-2 mt-2 cursor-pointer">
              ...
              />
              <span className="text-xs text-gray-500">Skip resume upload (free tier only)</span>
            </label>
          </div>
          ...
          <button
            type="submit"
            className="w-full py-3 bg-emerald-500 hover:bg-emerald-600 text-white text-base font-semibold rounded-xl transition-all shadow-lg shadow-emerald-500/25 hover:shadow-emerald-500/40 hover:-translate-y-0.5"
