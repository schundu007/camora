...
const CAMORA_PLANS = [
  {
    ...
    features: ['1 session (60 min)', 'All AI features', 'All platforms (Zoom, Meet, Teams)', 'Emergency blank (⌘B)', 'System audio capture'],
    cta: 'Try Free',
    ctaHref: '/lumora',
    popular: false,
...
export default function PricingPage() {
  ...
  return (
    <div className="min-h-screen" style={{ background: 'linear-gradient(180deg, #ffffff 0%, #f0fdf4 30%, #ecfeff 60%, #f5f3ff 85%, #ffffff 100%)' }}>
      ...
      {/* Deep Dive Comparison (interactive component) */}
