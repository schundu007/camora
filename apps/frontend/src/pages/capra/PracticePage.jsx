    ...
    <div className="practice-root" style={{ background: 'transparent', minHeight: '100vh' }}>
      ...
      {showPaywall && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm" onClick={() => setShowPaywall(false)}>
          <div className="bg-white rounded-3xl shadow-2xl max-w-2xl w-full mx-4 p-8" onClick={e => e.stopPropagation()}>
            {/* Header */}
            <div className="text-center mb-6">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-1">Upgrade to Continue</h3>
              <p className="text-sm text-gray-500">Choose a plan to unlock all practice problems and AI features</p>
            </div>
