    ...
    <div className="min-h-screen flex flex-col">
      <main className="flex-1 pt-20 pb-12 px-4">
        <div className="max-w-3xl mx-auto">
          ...
          {/* Progress summary */}
          <div className="mt-6 bg-[var(--bg-surface)] border-0 rounded-2xl p-5 shadow-[0_4px_24px_rgba(118,185,0,0.12)]">
          ...
          <div className="mt-8 space-y-5">
            {plan.map((day) => {
              ...
              return (
                <div key={day.day} className="bg-[var(--bg-surface)] border-0 rounded-2xl overflow-hidden shadow-[0_4px_24px_rgba(118,185,0,0.12)]">
                  {/* Day header */}
