...
function ActivityHeatmap() {
  ...
  const getColor = (v: number) => {
    ...
    if (v === 1) return 'rgba(0,71,171,0.2)';
    if (v === 2) return 'rgba(0,71,171,0.4)';
    if (v === 3) return 'rgba(0,71,171,0.6)';
    return 'rgba(0,71,171,0.85)';
  };
...
function SubscriptionCard() {
  ...
  return (
    <div className="rounded-2xl overflow-hidden" style={{ background: 'rgba(255,255,255,0.75)', backdropFilter: 'blur(12px)', border: '1px solid rgba(56,189,248,0.12)', boxShadow: '0 1px 4px rgba(56,189,248,0.06)' }}>
      <div className="px-5 py-3 flex items-center justify-between" style={{ background: 'rgba(0,71,171,0.04)', borderBottom: '1px solid rgba(56,189,248,0.1)' }}>
...
function ProfileSettings() {
  ...
  return (
    <div className="rounded-2xl overflow-hidden" style={{ background: 'rgba(255,255,255,0.75)', backdropFilter: 'blur(12px)', border: '1px solid rgba(56,189,248,0.12)', boxShadow: '0 1px 4px rgba(56,189,248,0.06)' }}>
      <div className="px-5 py-3" style={{ background: 'rgba(0,71,171,0.04)', borderBottom: '1px solid rgba(56,189,248,0.1)' }}>
