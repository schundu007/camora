...
function ActivityHeatmap() {
  ...
  const getColor = (v: number) => {
    ...
    if (v === 1) return 'rgba(34,211,238,0.2)';
    if (v === 2) return 'rgba(34,211,238,0.4)';
    if (v === 3) return 'rgba(34,211,238,0.6)';
...
function SubscriptionCard() {
  ...
  return (
    <div className="rounded-2xl overflow-hidden" style={{ background: 'rgba(255,255,255,0.75)', backdropFilter: 'blur(12px)', border: '1px solid rgba(56,189,248,0.12)', boxShadow: '0 1px 4px rgba(56,189,248,0.06)' }}>
      <div className="px-5 py-3 flex items-center justify-between" style={{ background: 'rgba(34,211,238,0.04)', borderBottom: '1px solid rgba(56,189,248,0.1)' }}>
        ...
        {endDate && sub?.status === 'active' && (
          <span className="text-xs px-3 py-1 rounded-full font-medium" style={{ color: '#f59e0b', background: 'rgba(245,158,11,0.08)', border: '1px solid rgba(245,158,11,0.2)' }}>
...
function ProfileSettings() {
  ...
  return (
    <div className="rounded-2xl overflow-hidden" style={{ background: 'rgba(255,255,255,0.75)', backdropFilter: 'blur(12px)', border: '1px solid rgba(56,189,248,0.12)', boxShadow: '0 1px 4px rgba(56,189,248,0.06)' }}>
      <div className="px-5 py-3" style={{ background: 'rgba(34,211,238,0.04)', borderBottom: '1px solid rgba(56,189,248,0.1)' }}>
