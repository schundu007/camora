  ...
  return (
    ...
    <div className="fixed inset-0 w-full flex overflow-hidden" style={{ background: '#F0F7FF' }}>
      ...
      <div className="flex-1 flex flex-col min-h-0 min-w-0 pb-[calc(64px+env(safe-area-inset-bottom))] md:pb-0">
        ...
        {showSettingsHint && (
          <div className="flex items-center justify-between px-4 py-2 shrink-0" style={{ background: 'rgba(236,72,153,0.08)', borderBottom: '1px solid rgba(236,72,153,0.15)' }}>
                      ...
                      return (
                        ...
                        >
                          <span className="flex items-center justify-center w-7 h-7 rounded-md text-[11px] font-bold shrink-0"
                            style={{ background: 'rgba(236,72,153,0.08)', color: 'var(--cam-primary)', fontFamily: 'var(--font-code)' }}>
                            {realIdx + 1}
                          </span>
