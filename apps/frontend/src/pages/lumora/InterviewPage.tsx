                    ...
                    <div className="flex items-center justify-between px-3 py-2 border-t border-slate-200">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <button onClick={handleInputSubmit} disabled={!inputValue.trim() || isStreaming}
                          ...
                          style={{ background: inputValue.trim() ? 'linear-gradient(135deg, #0D9488, #0D9488)' : '#e2e8f0' }}>
                          Send
                        </button>
                      </div>
                    </div>
                  ...
                  <div className="flex items-center gap-2 rounded-2xl px-4 h-12 transition-all focus-within:shadow-[0_0_0_2px_rgba(11,92,255,0.3)]"
                    ...
                    {inputValue.trim() && !isStreaming && (
                      <button onClick={handleInputSubmit}
                        ...
                        style={{ background: 'linear-gradient(135deg, #0D9488, #0D9488)', boxShadow: '0 2px 8px rgba(11,92,255,0.3)' }}>
