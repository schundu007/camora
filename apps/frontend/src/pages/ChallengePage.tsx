  ...
  return (
    <div className="ch-root">
      ...
      <section className="ch-hero">
        ...
        <div className="relative z-10 w-full lg:max-w-[75%] mx-auto px-4 sm:px-6 flex flex-col items-center justify-center text-center" style={{ minHeight: 'calc(85vh - 82px)', paddingTop: 48, paddingBottom: 48 }}>
          {/* Badge */}
      ...
      <section className="ch-section">
        <div className="w-full lg:max-w-[75%] mx-auto px-4 sm:px-6">
          {!isAuthenticated ? (
      ...
      <section className="ch-section" style={{ paddingTop: 24, paddingBottom: 24 }}>
        <div className="w-full lg:max-w-[75%] mx-auto px-4 sm:px-6 text-center">
