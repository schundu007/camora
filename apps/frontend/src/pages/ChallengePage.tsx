...
// as the title text color, so each color must be readable as text on white
...
const STEPS = [
  ...
  { num: '06', title: 'Win & join', desc: 'Prizes + founding team offers.', color: 'var(--text-muted)' },
];
...
const SCORING = [
  ...
  { category: 'Infrastructure', points: '5 pts', color: 'var(--cam-primary-dk)' },
  ...
  return (
    <div className="ch-root">
        ...
        <div className="w-full lg:max-w-[85%] mx-auto px-4 sm:px-6">
          {!isAuthenticated ? (
            ...
            <div className="ch-glass-card p-6">
              <div className="flex items-center justify-between flex-wrap gap-4 mb-5">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <span className="text-base text-[var(--text-muted)] ml-2">Score: {challengeStatus.quizScore}%</span>
                  </div>
                </div>
              ...
              <div className="border-t border-[var(--border)] pt-5">
                ...
                <div className="flex items-center gap-3">
                  ...
                  {submitStatus === 'success' && <span className="text-base text-[var(--accent)] font-medium">Submitted!</span>}
            ...
            <div className="ch-glass-card text-center py-12">
              <div className="ch-glow-icon mx-auto mb-4" style={{ '--glow': 'var(--accent)', width: 56, height: 56 } as any}>
                <svg className="w-7 h-7 text-[var(--accent)]" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
              </div>
            ...
            {PRIZES.map((p, i) => (
              <div key={p.place} className="ch-prize-card" style={{ '--prize-glow': p.glow, animationDelay: `${i * 0.1}s` } as any}>
                <div className="ch-prize-card-inner">
                  ...
                  {p.winners && <div className="text-base text-[var(--text-muted)]">({p.winners} winners)</div>}
            ...
            <div className="ch-glass-card p-6" style={{ borderColor: 'var(--border)' }}>
              ...
              <ul className="space-y-2">
                {['Competitive salary + significant equity', 'Remote-first, async culture', 'Build core platform from day one', 'Direct product influence', 'Full AI/ML stack'].map(b => (
                  <li key={b} className="flex items-start gap-2 text-base text-[var(--text-muted)]"><span className="text-[var(--cam-primary)] mt-px">&#10003;</span>{b}</li>
                ))}
              </ul>
            </div>
            <div className="ch-glass-card p-6" style={{ borderColor: 'var(--border)' }}>
          ...
          <div className="ch-timeline">
            {STEPS.map((s, i) => (
              <div key={s.num} className="ch-timeline-step">
                ...
                <p className="text-base text-[var(--text-muted)] leading-snug">{s.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="ch-section">
        <div className="w-full lg:max-w-[85%] mx-auto px-4 sm:px-6">
          <div className="ch-section-head">
            <span className="ch-section-tag" style={{ color: 'var(--text-muted)' }}>Rankings</span>
          ...
          <div className="ch-glass-card overflow-hidden p-0">
            <div className="grid grid-cols-12 gap-2 px-5 py-3 text-base font-bold text-[var(--text-muted)] uppercase tracking-wider border-b border-[var(--border)]">
      ...
      <section className="ch-section relative overflow-hidden">
        ...
        <div className="relative z-10 w-full lg:max-w-[60%] mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="mt-3 text-base text-[var(--text-muted)]">$21,812 in prizes + founding team spots.</p>
      ...
      {/* ═══ STYLES ═══
           ...
           cleanly between light + dark themes. Global text-color guard
           in globals.css doesn't reach <style> blocks (only inline
           style="..." attrs), so this file owns its own theme contract. */}
      <style>{`
        .ch-root {
          min-height: 100vh;
          display: flex;
        ...
        .ch-timeline-line {
          ...
          height: 2px; z-index: 1; background: var(--border);
        }
