...
export default function AdminLumoraLivePage() {
  return (
    <DocsPageLayout
    ...
    >
      ...
      <section id="overview" className="mb-12 scroll-mt-24">
        ...
        <DocsCallout variant="note" label="Audience for this page">
          This page is the internal architecture reference. End-user instructions for candidates
          using Lumora during a real interview live on the customer-facing page at{' '}
          <Link to="/docs/lumora-live" className="text-[var(--accent)] underline">/docs/lumora-live</Link>.
        </DocsCallout>
      </section>
      ...
      <DocsCallout variant="note" label="Looking for the user guide?">
        End-user instructions live on the customer-facing page at{' '}
        <Link to="/docs/lumora-live" className="text-[var(--accent)] underline">/docs/lumora-live</Link>.
        This page is the architecture reference for engineers and admins.
      </DocsCallout>
    </DocsPageLayout>
  );
}
