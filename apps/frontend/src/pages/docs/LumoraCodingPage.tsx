...
export default function LumoraCodingDocsPage() {
  return (
    <DocsPageLayout
      title="Lumora Coding"
      description="Architecture and operational reference for Lumora's coding tab — three-approach solutions with complexity analysis, the 3-pass reliability pipeline, and the structured JSON solution schema."
