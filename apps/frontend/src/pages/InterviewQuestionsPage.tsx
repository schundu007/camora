  ...
  return (
    <div className="min-h-screen bg-[#fafbfc] flex flex-col">
      ...
      <main className="flex-1 max-w-3xl w-full mx-auto px-4 py-10 space-y-12">
          ...
          <div className="space-y-3">
            {company.sampleQuestions.map((question, i) => {
              ...
              return (
                <div
                  key={i}
                  className={`relative bg-white border border-[#e3e8ee] rounded-xl p-5 ${isBlurred ? 'select-none' : ''}`}
                >
                  {isBlurred && (
        ...
        <section>
          ...
          <div className="grid gap-3 sm:grid-cols-3">
            {company.tips.map((tip, i) => (
              <div key={i} className="bg-white border border-[#e3e8ee] rounded-xl p-5">
        ...
        {/* CTA */}
        <section className="text-center bg-white border border-[#e3e8ee] rounded-2xl p-8">
