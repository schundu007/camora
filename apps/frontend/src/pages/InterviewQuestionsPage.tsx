  ...
  return (
    <div className="min-h-screen bg-[#fafbfc] flex flex-col">
      ...
      <main className="flex-1 max-w-3xl w-full mx-auto px-4 py-10 space-y-12">
          ...
          <div className="space-y-3">
            {company.sampleQuestions.map((question, i) => {
              ...
              return (
                <div
                  key={i}
                  className={`relative bg-[var(--bg-surface)] border-0 rounded-xl p-5 shadow-[0_4px_24px_rgba(45,140,255,0.12)] ${isBlurred ? 'select-none' : ''}`}
                >
                  {isBlurred && (
        ...
        <section>
          ...
          <div className="grid gap-3 sm:grid-cols-3">
            {company.tips.map((tip, i) => (
              <div key={i} className="bg-[var(--bg-surface)] border-0 rounded-xl p-5 shadow-[0_4px_24px_rgba(45,140,255,0.12)]">
        ...
        {/* CTA */}
        <section className="text-center bg-[var(--bg-surface)] border-0 rounded-2xl p-8 shadow-[0_4px_24px_rgba(45,140,255,0.12)]">
            ...
            {related.map((relSlug) => {
              ...
              return (
                <Link
                  ...
                  className="bg-[var(--bg-surface)] border-0 rounded-xl p-4 text-center shadow-[0_4px_24px_rgba(45,140,255,0.12)] hover:shadow-[0_20px_60px_rgba(45,140,255,0.28)] transition-all"
                >
