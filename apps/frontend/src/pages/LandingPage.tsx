...
const L = {
  ...
  glow: '0 0 60px rgba(118,185,0,0.08)',
  glowStrong: '0 0 80px rgba(118,185,0,0.15)',
};
...
const TOPICS = [
  ...
  { name: 'Microservices', count: 27, problems: 0, color: '#76B900' },
];
    ...
    <div className="min-h-screen relative" style={{ fontFamily: F.body, color: L.text, background: L.bg }}>
      ...
      <div className="absolute top-0 z-[3] pointer-events-none hidden lg:block" style={{ left: 'calc(15% + 18px)', bottom: '120px' }}>
        ...
        <div className="fixed hidden lg:block" style={{
          ...
          <div style={{ position: 'absolute', top: '100%', left: '50%', transform: 'translateX(-50%)', width: '3px', height: '140px', borderRadius: '2px', background: 'linear-gradient(to bottom, rgba(255,255,255,0.5), rgba(118,185,0,0.15), transparent)' }} />
          ...
          <svg width="56" height="64" viewBox="0 0 56 64" fill="none" style={{ filter: 'drop-shadow(0 4px 12px rgba(0,0,0,0.5)) drop-shadow(0 0 20px rgba(118,185,0,0.5))' }}>
            ...
            <path d="M27 38 L28 30 L28 38Z" fill="#76B900" opacity="0.4" />
            {/* Cockpit */}
