...
function getCompanyColor(name: string): string {
  const colors = ['#76B900', '#76B900', '#3b82f6', '#06b6d4', '#ec4899', '#76B900', '#10b981', '#ef4444', '#f59e0b', '#a855f7'];
  let hash = 0;
          ...
          <div className="w-full lg:max-w-[70%] mx-auto px-4 sm:px-6 lg:px-8" style={{ paddingTop: '8px', paddingBottom: '8px' }}>
            {!showUrlInput ? (
              ...
              <div style={{ maxWidth: '720px', margin: '0 auto' }}>
                ...
                {/* Error message */}
                {analyzeError && (
                  <div style={{ fontSize: '13px', color: '#5E9400', background: '#fef2f2', border: '1px solid #fecaca', borderRadius: '8px', padding: '10px 14px', marginBottom: '8px' }}>
                    {analyzeError}
                  </div>
                )}
        ...
        <div className="w-full lg:max-w-[70%] mx-auto px-4 sm:px-6 lg:px-8" style={{ paddingTop: '12px' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px', flexWrap: 'wrap' }}>
            ...
            {[
              ...
              { val: departmentFilter, set: setDepartmentFilter, label: departmentFilter, color: '#76B900' },
                ...
                return (
                  ...
                  >
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', borderTop: '1px solid var(--border)', padding: '10px 16px', marginTop: '10px' }}>
                      ...
                      <Link to={`/capra/resume?company=${encodeURIComponent(job.company_name)}&role=${encodeURIComponent(job.title)}&url=${encodeURIComponent(job.job_url)}`} className="jobs-action-link-resume" style={{ fontSize: '12px', fontWeight: 600, color: '#76B900', textDecoration: 'none', display: 'flex', alignItems: 'center', gap: '4px' }}>
                        Resume
