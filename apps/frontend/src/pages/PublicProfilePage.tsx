    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <main className="flex-1 w-full lg:max-w-[70%] mx-auto px-4 sm:px-6 pt-24 pb-16">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-10">
          <div className="bg-gradient-to-br from-white/80 to-indigo-50/30 border border-indigo-200/30 rounded-xl px-4 py-3 text-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {profile.certificates.map((cert) => (
                <Link
                  ...
                  className="flex items-start gap-3 bg-gradient-to-br from-white/80 to-indigo-50/30 border border-indigo-200/30 rounded-xl px-5 py-4 hover:shadow-sm transition-shadow"
                >
                  {/* Certificate icon */}
