    ...
    <div className="min-h-screen bg-[var(--bg-app)] flex flex-col">
      ...
      <main className="flex-1 w-full lg:max-w-[70%] mx-auto px-4 sm:px-6 pt-24 pb-16">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-10">
          <div className="bg-[var(--bg-app)] border-0 rounded-xl px-4 py-3 text-center shadow-[0_4px_24px_rgba(118,185,0,0.12)]">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {profile.certificates.map((cert) => (
                <Link
                  ...
                  className="flex items-start gap-3 bg-[var(--bg-app)] border-0 rounded-xl px-5 py-4 shadow-[0_4px_24px_rgba(118,185,0,0.12)] hover:shadow-[0_20px_60px_rgba(118,185,0,0.28)] transition-shadow"
                >
                  {/* Certificate icon */}
